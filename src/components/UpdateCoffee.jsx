...
const UpdateCoffee = () => {
   ...
   .then(res=> res.json())
    ...
    return (
        ...
        <h2 className="text-3xl font-extrabold text-blue-500">Update Coffe: {name}</h2>
        <form onSubmit={handleUpdateCoffee}>
            ...
            <label className="input-group">
                <input type="text" name="details" defaultValue={details} placeholder="category details" className="input input-bordered w-full" />
            </label>
        </div>
     ...
     <input type="submit" value="Update Coffee" className="btn bg-black text-white btn-block" />
        </form>
    </div>
    );
};
